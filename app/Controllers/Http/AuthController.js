...
class AuthController {
  ...
  async sendResetLink({ request, response, session }) { // Função incompleta, falta integração com SMTP
    try {
  ...
  async resetPassword({ request, response, session }) { // Função incompleta, falta integração com SMTP
    try {
