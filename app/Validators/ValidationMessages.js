...
module.exports = {
  ...
  max: (field, length) => `O campo ${field} deve ter no máximo ${length} caracteres.`,
  min: (field, length) => `O campo ${field} deve ter no mínimo ${length} caracteres.`,
  ...
  in: (field, values) => `O campo ${field} deve ser um dos valores permitidos: ${values}.`,
  notIn: (field, values) => `O campo ${field} não pode ser um dos valores: ${values}.`,
  ...
  enum: (field, values) => `O campo ${field} deve ser um dos valores permitidos: ${values}.`,
};
